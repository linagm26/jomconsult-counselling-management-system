                          ...
                          <tbody>
                            <tr role="row" class="odd">
                              ...
                              try {
                                ...
                                $stmt = $conn->prepare("select * from tbl_consultation ORDER BY consultationDate DESC, consultationTime ASC LIMIT $start_from, $per_page");
                                $stmt->execute();
                              ...
                              foreach($result as $readrow) {
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <a href="admin_consultation_details.php?listD=<?php echo $readrow['consultationID']; ?>" class="status_btn" role="button">Details</a>
                                  </td>
                                </tr>
                              <?php }  ?>
                            </tr>
                          ...
                          <div class="dataTables_paginate paging_simple_numbers">
                            ...
                            if ($page == 1) { ?>
                              ...
                              <li class="paginate_button next">
                                <a class="page-link" href="admin_consultation.php?page=<?php echo $page - 1 ?>" aria-label="Previous">
                              ...
                              for ($i = 1; $i <= $total_pages; $i++) { ?>
                                <li class="paginate_button <?php echo ($i == $page) ? 'active' : ''; ?>">
                                  <a class="page-link" href="admin_consultation.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>
                                ...
                                <?php if ($page == $total_pages) { ?>
                                  ...
                                  <?php } else { ?>
                                    <li class="page-item">
                                      <a class="page-link" href="admin_consultation.php?page=<?php echo $page + 1 ?>" aria-label="Next">
